...
【免费交流群】欢迎👏🏻👏🏻👏🏻加入AI工具大百科交流群，与AI领域专家和各行各业的ChatGPT爱好者一起交流碰撞💥💥💥！不管你是专业人士还是爱好者，都欢迎加入群体！

![交流群](https://github.com/xiaoqdu/allinchatgpt/blob/main/aigroup.jpg?raw=true)

研究报告可打开自己的视野，对AIGC领域有一个全面认识。收集整理不易
免费领取条件：点击小星星关注的用户，并加入了"AI工具大百科"的用户可回复"领取报告"

- 研究报告
  - [2022年中国AI+金融行业发展研究报告(27页).pdf](http://) - 27页
  - [2023最热赛道出现：AIGC(10页 ).pdf](http://) - 10页
  - [36氪研究院 -2023年AIGC之ChatGPT(6页).pdf](http://) - 6页
  - [AIGC&ChatGPT发展专题分析报告(16页).pdf](http://) - 16页
  - [AIGC专题研究报告：拐点时刻（18页).pdf](http://) - 18页
  - [AIGC和智能数字化新时代：媲美新石器时文明范式转型(12页).pdf](http://) - 12页
  - [AIGC将如何影响传媒行业(16页).pdf](http://) - 16页
  - [AIGC趋势报告2013-迎接人工智能的下一个时代（腾讯研究院)(59页).pdf](http://) - 59页
  - [ChatGPT国安证券分析报告(70页).pdf](http://) - 70页
  - [ChatGPT打响AI算力军备战(22页).pdf](http://) - 22页
  - [ChatGPT更懂人类的叙事(20页).pdf](http://) - 20页
  - [IGC有望引领人工智能的商业化浪潮(28页).pdf](http://) - 28页
  - [一文读懂AIGC的前世（35页).pdf](http://) - 35页
...
- 基本原理
  ...
  - [一文读懂ChatGPT模型原理](https://zhuanlan.zhihu.com/p/589621442?utm_source=zhihu&utm_id=0) - nan
  - [ChatGPT原理剖析 李宏毅](https://www.bilibili.com/video/BV1jA411274Q/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - nan
  - [台大李宏毅自注意力机制和Transformer详解！](https://www.bilibili.com/video/BV1v3411r78R/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - nan
- 版本说明
...
- 注册过程
  ...
  - [24小时成功订阅ChatGPT Plus](https://www.bilibili.com/video/BV11M411Y7PV/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - nan
  - [Chat GPT升级成Plus教程.pdf](https://github.com/xuyihui1996/GPT-) - nan
- 基本使用
...
- 提示工程
  ...
  - [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) - nan
  - [ChatGPT "DAN" (and other "Jailbreaks") 越狱 PROMPTS](https://github.com/0xk1h0/ChatGPT_DAN) - nan
...
- 提示工程工具
  ...
  - [PromptSpace](https://promptspace.xyz/?ref=nav.6aiq.com) - nan
- 模型微调
  - [Learn how to customize a model for your application.](https://platform.openai.com/docs/guides/fine-tuning) - openai官网参考资料
  - [What are embeddings?](https://platform.openai.com/docs/guides/embeddings) - openai官网参考资料
  - [LlamaIndex](https://github.com/jerryjliu/llama_index) - LlamaIndex（GPT索引）是一个项目，它将您的LLM与外部数据连接起来。
...
- SDK、API接口
  - [精选的 ChatGPT 资源列表，包括库、SDK、API](https://github.com/eon01/awesome-chatgpt#python) - 精选的 ChatGPT 资源列表，包括库、SDK、API
  - [OpenAI Cookbook](https://github.com/openai/openai-cookbook) - OpenAI Cookbook 分享了使用 OpenAI API 完成常见任务的示例代码。
  - [Reverse engineered ChatGPT API](https://github.com/acheong08/ChatGPT) - 逆向工程的 ChatGPT API
- ChatGPT镜像站
...
- AutoGPT
  ...
  - [Auto-GPT无脑使用教程！掌握只领工资，不干活技巧！](https://www.bilibili.com/video/BV1HV4y1Z7dm/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - nan
- BabyAGI
  - [BabyAGI](https://github.com/yoheinakajima/babyagi) -  Python 脚本是 AI 驱动的任务管理系统的示例。该系统使用 OpenAI 和 Pinecone API 来创建、确定优先级和执行任务。
  - [babyAGI 简介：AI 世界的最新成员](https://www.toutiao.com/article/7223294821358912040/?channel=&source=search_tab) - nan
  - [BabyAGI-基于LangChain的新型自主人工智能代理系统](https://www.bilibili.com/video/BV1ts4y1E7om/?vd_source=a839a656d82f50d2b08ae4042d5a0e51) - nan
- wolverine
  - [wolverine](https://github.com/biobootloader/wolverine) - 可以自动执行和修复代码的脚本程序
  - [GPT4 让 Python 拥有「金刚狼」的无限修复（治愈）能力](https://www.bilibili.com/video/BV1ck4y1e7qb/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - wolverine介绍视频
- Cursor
...
- Visual ChatGPT
  ...
  - [微软 Visual ChatGPT 深度全解析（安装使用、案例解析、原理剖析）](https://www.bilibili.com/video/BV1U54y1K7tG/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - Visual ChatGPT参考资料
  - [Visual ChatGPT实战分享_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1ns4y1P7FJ/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - Visual ChatGPT参考资料
- AgentGPT
  - [AgentGPT](https://github.com/reworkd/AgentGPT) - AgentGPT 允许您配置和部署自治 AI 代理。 命名你自己的自定义 AI，让它开始实现任何可以想象的目标. 类似AutoGPT
  - [AgentGPT 在线体验网址](https://agentgpt.reworkd.ai/) - AgentGPT 在线体验网址
  - [带你体验AgentGPT,让任务全自动化的产品](https://baijiahao.baidu.com/s?id=1763388602966957185&wfr=spider&for=pc) - AgentGPT参考资料
  - [AgentGPT实战：创建一家基于人工智能技术的高科技公司](https://www.cnblogs.com/botai/p/AgentGPT-build-ai-company.html) - AgentGPT参考资料
  - [人工智能自己完成任务，AgentGPT职场新卷王](https://www.bilibili.com/video/BV1P24y1c7Tn/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - AgentGPT参考资料
- ChatPDF
...
- ChatGPT+
  ...
  - [chatgpt-mac](https://github.com/vincelwt/chatgpt-mac) - 这是一个Mac上支持ChatGPT的应用程序，使ChatGPT在您的菜单栏中。
  - [ChatGPT (and GPT4) Wrapper](https://github.com/mmabrouk/chatgpt-wrapper) - 用于使用 Python 和 Shell 与 ChatGPT 和 GPT4 交互的 API。
  - [chatgpt-vscode](https://github.com/mpociot/chatgpt-vscode) - vscode使用chatgpt
  - [AICommand](https://github.com/keijiro/AICommand) - ChatGPT integration with Unity Editor
  - [chatgpt-andriod](https://github.com/skydoves/chatgpt-android) - ChatGPT Android 在 Android 上使用 Stream Chat SDK for Compose 演示 OpenAI 的 ChatGPT。
  - [ChatGPT](https://github.com/lencx/ChatGPT) - ChatGPT 桌面应用,支持 (Mac, Windows and Linux)
...
- ChatGPT+midjourney
  ...
  - [ChatGPT+Midjourney将颠覆传统服装行业](https://www.bilibili.com/video/BV1Vo4y1H7Q7/?spm_id_from=333.788.recommend_more_video.8&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - 一套服装从设计草图到能够去电商上架，用ChatGPT和Midjourney1个小时可以完成
  - [新手小白利用ChatGpt+MidJourney+D-ID生产视频](https://www.bilibili.com/video/BV1v24y1g79p/?spm_id_from=333.788.recommend_more_video.1&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - 生成数字人
  - [ChatGPT、Midjourney用AI快速制作3D版儿童绘本](https://www.bilibili.com/video/BV13k4y147bN/?spm_id_from=333.788.recommend_more_video.12&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - 生成儿童绘本
...
- 学术研究者
  ...
  - [ChatPDF - 文献阅读神器](https://www.bilibili.com/read/cv22761591) - ChatPDF进行论文内容查询解析
  - [chatGPT在科研、论文中的应用避坑指南！](https://www.bilibili.com/video/BV1So4y1Y76S/?spm_id_from=333.337.search-card.all.click&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - chatGPT在论文撰写中的应用
  - [ChatGPT六步提问法：你若诚心发问，它会给你一篇惊艳论文！](https://www.bilibili.com/video/BV16s4y177Pz/?spm_id_from=333.788.recommend_more_video.1&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - chatGPT在论文撰写中的应用
- 社交媒体管理者
  - [应用案例](http://) - 持续更新中……
- 私人助理
  - [应用案例](http://) - 持续更新中……
...
- 心理医生 心理咨询师
  - [应用案例](http://) - 持续更新中……
- 游戏开发者
  - [ChatGPT初体验：问AI不用改代码完成了第一款游戏](https://www.bilibili.com/video/BV1RG4y1g7P2/?spm_id_from=333.788.recommend_more_video.-1&vd_source=a839a656d82f50d2b08ae4042d5a0e51) - ChatGPTh游戏初体验
- 设计师
  - [应用案例](http://) - 持续更新中……
- 管理顾问 咨询师
  - [应用案例](http://) - 持续更新中……
